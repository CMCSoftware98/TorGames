...
const countryNames: Record<string, string> = {
  ...
  'bg': 'Bulgaria', 'bh': 'Bahrain', 'bi': 'Burundi', 'bj': 'Benin', 'bl': 'St. Barthélemy',
  'bm': 'Bermuda', 'bn': 'Brunei', 'bo': 'Bolivia', 'bq': 'Caribbean NL', 'br': 'Brazil',
  'bs': 'Bahamas', 'bt': 'Bhutan', 'bv': 'Bouvet Island', 'bw': 'Botswana', 'by': 'Belarus',
  'bz': 'Belize', 'ca': 'Canada', 'cc': 'Cocos Islands', 'cd': 'DR Congo', 'cf': 'CAR',
  ...
  'de': 'Germany', 'dj': 'Djibouti', 'dk': 'Denmark', 'dm': 'Dominica', 'do': 'Dominican Rep.',
  'dz': 'Algeria', 'ec': 'Ecuador', 'ee': 'Estonia', 'eg': 'Egypt', 'eh': 'Western Sahara',
  'er': 'Eritrea', 'es': 'Spain', 'et': 'Ethiopia', 'fi': 'Finland', 'fj': 'Fiji',
  'fk': 'Falklands', 'fm': 'Micronesia', 'fo': 'Faroe Islands', 'fr': 'France', 'ga': 'Gabon',
  ...
  'gp': 'Guadeloupe', 'gq': 'Eq. Guinea', 'gr': 'Greece', 'gs': 'S. Georgia', 'gt': 'Guatemala',
  'gu': 'Guam', 'gw': 'Guinea-Bissau', 'gy': 'Guyana', 'hk': 'Hong Kong', 'hm': 'Heard Island',
  'hn': 'Honduras', 'hr': 'Croatia', 'ht': 'Haiti', 'hu': 'Hungary', 'id': 'Indonesia',
  'ie': 'Ireland', 'il': 'Israel', 'im': 'Isle of Man', 'in': 'India', 'io': 'BIOT',
  ...
  'mg': 'Madagascar', 'mh': 'Marshall Islands', 'mk': 'N. Macedonia', 'ml': 'Mali', 'mm': 'Myanmar',
  'mn': 'Mongolia', 'mo': 'Macau', 'mp': 'N. Mariana Islands', 'mq': 'Martinique', 'mr': 'Mauritania',
  ...
  'ph': 'Philippines', 'pk': 'Pakistan', 'pl': 'Poland', 'pm': 'St. Pierre', 'pn': 'Pitcairn',
  ...
  'se': 'Sweden', 'sg': 'Singapore', 'sh': 'St. Helena', 'si': 'Slovenia', 'sj': 'Svalbard',
  'sk': 'Slovakia', 'sl': 'Sierra Leone', 'sm': 'San Marino', 'sn': 'Senegal', 'so': 'Somalia',
  'sr': 'Suriname', 'ss': 'South Sudan', 'st': 'São Tomé', 'sv': 'El Salvador', 'sx': 'Sint Maarten',
  'sy': 'Syria', 'sz': 'Eswatini', 'tc': 'Turks & Caicos', 'td': 'Chad', 'tf': 'French S. Terr.',
  ...
  'um': 'U.S. Outlying Islands', 'us': 'United States', 'uy': 'Uruguay', 'uz': 'Uzbekistan', 'va': 'Vatican',
  'vc': 'St. Vincent', 've': 'Venezuela', 'vg': 'British VI', 'vi': 'U.S. VI', 'vn': 'Vietnam',
...
const headers = [
  { title: 'Country', key: 'countryCode', sortable: true, width: '150px' },
      ...
      >
        ...
        <template #item.countryCode="{ item }">
          <div class="d-flex align-center ga-2">
            ...
            />
            <v-icon v-else icon="mdi-earth" size="small" class="text-medium-emphasis" />
            <span class="text-body-2">{{ getCountryName(item.countryCode) }}</span>
            <v-icon
              :icon="item.status === 'online' ? 'mdi-circle' : 'mdi-circle-outline'"
