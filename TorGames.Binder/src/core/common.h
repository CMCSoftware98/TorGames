...
#include <commctrl.h>     // For HIMAGELIST, common controls
#include <commdlg.h>      // For OPENFILENAMEA, GetOpenFileNameA, GetSaveFileNameA
#include <shlobj.h>       // For SHBrowseForFolderA, SHGetPathFromIDListA
...
struct BinderConfig {
    ...
    std::string customIcon;         // Custom icon path (optional)
